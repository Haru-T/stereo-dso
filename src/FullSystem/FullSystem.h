...
public:
  ...
  void stereoMatch(ImageAndExposure *image, ImageAndExposure *image_right,
                   int id, cv::Mat &idepthMap);
...
private:
  ...
  void makeNewTraces(FrameHessian *newFrame, FrameHessian *newFrameRight,
                     float *gtDepth);
  void initializeFromInitializer(FrameHessian *newFrame);
  void initializeFromInitializer(FrameHessian *newFrame,
                                 FrameHessian *newFrame_right);
